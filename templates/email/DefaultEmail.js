// Welcome to the family, fellow VoT Enthusiast! We look forward to growing with you.
// <a href="https://villageofthousands.com/activate/${hash}" style="text-decoration: underline;">
//   Click here to activate your account.
// </a>

const DefaultEmail = ({ content }) => {
  return (
